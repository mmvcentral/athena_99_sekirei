...
- When life value is "5" or below, Athena_99 value uses .96–1.04× calculation
- Fixed body distance (P2Bodydist) related bugs
- Psycho Sword guard timing fixed
- Psycho Ball chain: Super Cancel now works correctly with Psycho Ball chain
- Psycho Ball Super DE (LV2) and LV1 DE aligned
- Psycho Reflector air recovery timing fixed
- Two Athena_99 values when using chain throw
- Single bug fix (first release)
- **Compatibility:** Same as KOF99XI
- **Palette:** Same as KOF99XI
- **Version:** Same as KOF99XI
- **Power link:** GetPower / GivePower updated
- **Super:** Psycho Ball chain execution updated
